...
function TodoList() {
    ...
    const [isPopUpOpen, setIsPopUpOpen] = useState(false); // Aktif işlem ID'si
    ...
    return (
        <div className="todo-container">
            ...
            <div class="navbar">
                ...
                <a id="icon" style={{ color: isListEmpty ? "green" : "black" }} href="https://www.flaticon.com/free-icons/to-do" title="to do icons">Todo List</a>
                <a href="/">Çıkış Yap</a>
            ...
            <div className="DENEME">
                ...
                <div className="todoDesign">
                    ...
                    <Button type="submit" text="Ekle" onClick={handleSubmitAddTask} className='buttonDesign' />
                </div>
                <br />
                ...
                <div className="table-container">
                    <table>
                        <thead>
                            <tr>
                                <th className="tableTitle">Görev</th>
                                <th className="tableTitle">Tahmini Süre</th>
                                <th className="tableTitle">Harcanan Süre</th>
                                <th className="tableTitle">Tamamlanma Durumu</th>
                                <th className="tableTitle">İşlemler</th>
                            </tr>
                        </thead>
                        <tbody >
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        saveEditedTask(todo.id, e.target.value)
                                                    }}
